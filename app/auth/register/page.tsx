      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6">
        <div className="max-w-sm sm:max-w-md w-full bg-white rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8">
          <div className="text-center mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-secondary-900 mb-2">Create Account</h1>
            <p className="text-sm sm:text-base text-secondary-600">Join thousands of parents building their children's future together</p>
          </div>
          ...
          <form className="space-y-4 sm:space-y-6">
            <div>
              <label className="block text-xs sm:text-sm font-medium text-secondary-700 mb-1 sm:mb-1">Full Name</label>
            ...
            <div>
              <label className="block text-xs sm:text-sm font-medium text-secondary-700 mb-1 sm:mb-1">Email Address</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="h-4 w-4 sm:h-5 sm:w-5 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <label className="block text-xs sm:text-sm font-medium text-secondary-700 mb-1 sm:mb-1">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="h-4 w-4 sm:h-5 sm:w-5 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <label className="block text-xs sm:text-sm font-medium text-secondary-700 mb-1 sm:mb-1">Confirm Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="h-4 w-4 sm:h-5 sm:w-5 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="agree-terms" className="ml-2 block text-xs sm:text-sm text-secondary-700">
                I agree to the{' '}
